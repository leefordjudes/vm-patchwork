...
const PRINT_CONFIG = {
  ...
  AT010:
    '{"header":{"showBillTitle":true,"showOrganizationName":true,"showOrganizationAddress":true,"showOrganizationPhone":true,"showOrganizationEmail":true,"showOrganizationDetails":true,"showCustomerInfo":true,"showInvoiceInfo":true,"showContactInfo":true},"transactionInfo":{"serialNo":{"width":5,"label":"SLNO","enabled":true},"item":{"width":20,"label":"ITEMS","enabled":true},"rackName":{"width":10,"label":"RACK","enabled":false},"hsnCode":{"width":8,"label":"HSN","enabled":true},"batchNo":{"width":10,"label":"BATCH","enabled":false},"qty":{"width":7,"label":"QTY","enabled":true},"mrp":{"width":7,"label":"MRP","enabled":true},"expPeriod":{"width":13,"label":"EXP","enabled":false},"rate":{"width":10,"label":"RATE","enabled":true},"taxableValue":{"width":8,"label":"T.VALUE","enabled":true},"tax":{"width":6,"label":"TAX","enabled":true},"taxAmount":{"width":6,"label":"TAMT","enabled":true},"discount":{"width":6,"label":"DISC","enabled":true},"dAmount":{"width":6,"label":"DAMT","enabled":true},"amount":{"width":11,"label":"AMOUNT","enabled":true}},"footer":{"showBillDetails":true,"showGSTSummary":true},"greetings":{"text":"**Wish you a speedy recovery**","enabled":true}}',
  AT011:
